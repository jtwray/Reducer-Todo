...
export const todoReducer = (state, action) => {
  ...
  switch (action.type) {
    case "ADD_TODO": {
      ...
      console.log("state.todoList::::",state.todoList,"nextTodo:::",nextTodo,"action.payload::::",action.payload)
      return {
    ...
    case "TOGGLE_COMPLETED": {
      console.log("TOGGLE_COMPLETED is firing in the reducers/  action.payload:", action.payload);
